...
use App\Http\Controllers\KategoriSertifikatController;
...
Route::get('lsertifikat', [HomeWebController::class, 'sertifikat']);
Route::get('kontak', [HomeWebController::class, 'kontak']);
Route::get('daftar-agenda', [HomeWebController::class, 'daftaragenda']);
...
Route::middleware([
    ...
    Route::resource('kategori_sertifikat', KategoriSertifikatController::class);
