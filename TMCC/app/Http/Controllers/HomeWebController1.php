...
class HomeWebController extends Controller
{
    ...
    public function index()
    {
        ...
        ->limit(3)
        ->get();
        return view('welcome', compact('tim','berita', 'video', 'galeri', 'berita', 'chapter', 'region', 'community', 'user', 'banner'));
    }
    public function tentang()
    {
        ...
        $user = User::count();
        return view('tentang', compact('konf', 'community', 'region', 'chapter','user'));
    }
