...
class KegiatanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('kegiatan.create', compact('kategori_kegiatan', 'sub_kategori_kegiatan', 'title'));
    }
    ...
    public function edit(Kegiatan $kegiatan)
    {
        ...
        $sub_kategori_kegiatan = SubKategoriKegiatan::all();
        $title = 'Edit Kegiatan';
        return view('kegiatan.edit', compact('kategori_kegiatan', 'sub_kategori_kegiatan', 'title', 'kegiatan'));
    }
