	...
	<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<div class="navbar-nav ms-auto p-4 p-lg-0">
				...
				<a href="{{ url('tentang') }}" class="nav-item nav-link">Visi & Misi</a>
				<a href="{{ url('news') }}" class="nav-item nav-link">Berita</a>
				<a href="{{ url('agenda') }}" class="nav-item nav-link">Kegiatan</a>
				<div class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Halaman</a>
					<div class="dropdown-menu bg-light m-0">
						<a href="{{ url('lihat-galeri') }}" class="dropdown-item">Galeri</a>
						<a href="{{ url('sertifikasi') }}" class="dropdown-item">Sertifikat</a>
						<a href="{{ url('lihat-team') }}" class="dropdown-item">Tim</a>
					</div>
				</div>
				<a href="{{ url('kontak') }}" class="nav-item nav-link">Kontak</a>
				<a href="{{ route('login') }}" class="nav-item nav-link"><i class="bi bi-box-arrow-in-right"></i> Login</a>
			</div>
		</div>
	</nav>
	<!-- Navbar End -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
					&copy; <a class="fw-semi-bold" href="#">{{ $konf->perusahaan_setting }}</a>, All Right Reserved.
				</div>
				<div class="col-md-6 text-center text-md-end">
					<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
					Designed By <a class="fw-semi-bold" href="https://spunix.net">Spunix</a>
				</div>
			</div>
		</div>
	</div>
