        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('community.update', $community->id_community) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="nama_community" class="form-control" placeholder="Masukkan nama community" value="{{ $community->nama_community }}">
                    </div>
                </div>
