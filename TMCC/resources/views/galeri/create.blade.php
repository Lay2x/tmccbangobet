                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('galeri.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input required type="text" class="form-control" placeholder="Masukkan Judul Gambar disini...." name="nama_galeri" value="{{ old('nama_galeri') }}" required/>
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input id="inputImg" type="file" accept="image/*" name="gambar_galeri" class="form-control" required/>
