                ...
                <form action="{{ route('garasi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <select name="jenis_item" id="dropdown">
                            <option value=""></option>
                            @foreach ($data as $row)
                            <option value="{{ $row->id_garasi }}">{{ $row->jenis_item}}</option>
                            @endforeach
                        </select>
                        @error('jenis_item')
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan merek item disini..." name="merek_item" value="{{ old('merek_item') }}">
                        @error('merek_item')
                        <small class="text-danger">{{ $message }}</small>@enderror
                    </div>
                    <div class="form-group mb-2">
