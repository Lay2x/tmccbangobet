  ...
  <div class="wrapper">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('kategori_sertifikat.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Sertifikat</p>
                  </a>
                </li>

                <li class="nav-item">
                  <a href="{{ route('kategori_kegiatan.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Kegiatan</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('sub_kategori_kegiatan.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Sub Kategori Kegiatan</p>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="{{ route('kategori_dokumen.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Dokumen</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_iuran.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Iuran</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_user.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori User</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_admin.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Admin</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_pengurus.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Pengurus</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_anggota.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Anggota</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_unit_bisnis.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Unit Bisnis</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('kategori_karyawan.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Karyawan</p>
                  </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="{{ route('kategori_garasi.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Kategori Garasi</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('visi.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Visi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('misi.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Misi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('garasi.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Garasi</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('pusat.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Pusat</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                  <a href="{{ route('daftar_kegiatan.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Daftar Kegiatan</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="{{ route('data_berita.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Berita</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ url('ulang_tahun') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ulang Tahun Anggota</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('penjualan_produk.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <footer class="main-footer">
      <div class="float-right d-none d-sm-block">
        <b>TMCC Version</b> 0.1.0
      </div>
      <strong>Copyright &copy; <?php $cpy = date('Y');
                                echo $cpy; ?><a href="https://spunix.net"> &nbsp;<img class="img-fluid" src="{{ asset('spunix.png')}}" alt="" style="max-width: 10%;"></a>&nbsp;</strong> All rights reserved 
    </footer>
