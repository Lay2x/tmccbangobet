          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody class="overflow-x-auto">
              ...
              <tr>
                ...
                <td><a href="{{ route('daftar_kegiatan.edit', $row->id_daftar_kegiatan) }}" class="btn btn-primary btn-xs" role="button" style="display: inline-block"><i class="fas fa-edit">Edit</i></a>
