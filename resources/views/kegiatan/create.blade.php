            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="number" name="biaya_kegiatan" class="form-control" value="{{ old('biaya_kegiatan') }}">
                    </div>
                    <div class="form-group mb-2">
                        ...
                        <select name="id_status_kegiatan" id="dropdown" class="form-control">
                            ...
                            @foreach ($status_kegiatan as $row)
                                <option value="{{ $row->id_status_kegiatan }}">{{ $row->nama_status_kegiatan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group mb-2">
                        ...
                        <select name="id_publish_kegiatan" id="dropdown" class="form-control">
                            ...
                            @foreach ($publish_kegiatan as $row)
                                <option value="{{ $row->id_publish_kegiatan }}">{{ $row->nama_publish_kegiatan }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group mb-2">
